    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add(
                'content', 
                TextareaType::class, 
                $this->getConfiguration('Description détaillée', "Tapez une description qui donne vraiment envie")
            )
            ->add(
                'rooms', 
                IntegerType::class, 
            ...
            ->add(
                'price', 
                MoneyType::class, 
                $this->getConfiguration('Prix par nuit', "Indiquez le prix que vous souhaitez pour une nuit")
            )
            ->add(
                'images',
