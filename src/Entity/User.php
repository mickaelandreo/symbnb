 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="L'adresse e-mail renseignée est déjà présente en base de données"
 * )
 */
class User implements UserInterface
{
     ...
     * 
     * @Assert\NotBlank(
     *  message = "L'adresse e-mail ne peut pas être nulle"
     * )
     * 
     * @Assert\Email(
     ...
     * 
     * @Assert\NotBlank(
     *  message = "L'URL ne peut pas être nulle"
     * )
     * 
     * @Assert\Url(
     ...
     * @Assert\EqualTo(
     *  propertyPath = "hash",
     *  message = "Les 2 mots de passes doivent être identiques"
     * )
     */
     ...
     * @Assert\Length(
     *  min = 100,
     *  minMessage = "Votre description doit comporter au moins 100 caractères"
     * )
     */
    private $description;
